...
G4RadioactiveDecaymessenger::G4RadioactiveDecaymessenger(G4RadioactiveDecay *theRadioactiveDecayContainer1)
    : theRadioactiveDecayContainer(theRadioactiveDecayContainer1)
{
  ...
  old_sourcetimeprofileCmd->SetGuidance("Supply the name of the ascii file containing the source particle time profile");
  ...
  sourcetimeprofileCmd->SetGuidance("Supply the name of the ascii file containing the source particle time profile");
  ...
  old_decaybiasprofileCmd->SetGuidance("Supply the name of the ascii file containing the decay bias time profile");
  ...
  decaybiasprofileCmd->SetGuidance("Supply the name of the ascii file containing the decay bias time profile");
...
void G4RadioactiveDecaymessenger::SetNewValue(G4UIcommand *command, G4String newValues)
{
  ...
  {
    theRadioactiveDecayContainer->SetNucleusLimits(old_nucleuslimitsCmd->GetNewNucleusLimitsValue(newValues));
  ...
  {
    theRadioactiveDecayContainer->SetAnalogueMonteCarlo(old_analoguemcCmd->GetNewBoolValue(newValues));
    G4ExceptionDescription ed;
    ed << "This command is valid but deprecated and will be replaced with the command:\n"
  ...
  {
    theRadioactiveDecayContainer->SetNucleusLimits(nucleuslimitsCmd->GetNewNucleusLimitsValue(newValues));
  }
